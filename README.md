...
```hcl
github.com/pbs/terraform-aws-elasticache-redis-standalone-module?ref=1.0.9
```
...
```hcl
module "redis" {
  source = "github.com/pbs/terraform-aws-elasticache-redis-standalone-module?ref=1.0.9"
